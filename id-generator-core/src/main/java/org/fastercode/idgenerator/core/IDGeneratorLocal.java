...
public class IDGeneratorLocal implements IDGenerator {
    ...
    public int getWorkerID() {
        return (int) this.workerIdSupplier.getAsLong();
    }
     ...
     */
    @Override
    public long decodeWorkerIdFromId(final long id) {
     ...
     */
    @Override
    public long decodeExtraDataFromId(final long id) {
     ...
     */
    @Override
    public Date decodeCreateDateFromLong64(final long id) {
        if (id < (1L << 32L)) {
            return null;
        }
     ...
     */
    @Override
    public Date decodeCreateDateFromStr(final String str) {
        try {
     ...
     */
    @Override
    public String decodeCreateDateStringFromStr(final String str) {
